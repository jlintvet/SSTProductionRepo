...
import riplocIcon from "@/public/brand/riploc-app-icon-black.png";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 min-w-0">
        {/* Brand mark */}
        <img src={riplocIcon} alt="RipLoc" style={{height:32,width:"auto",display:"block",mixBlendMode:"multiply"}} />
